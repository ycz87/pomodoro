...
export const pt: Messages = {
  ...
  itemName: (id) => ({
    ...
    'star-dew': 'Essência Estelar',
    'trap-net': 'Rede Armadilha Alienígena',
    lullaby: 'Canção de Ninar Primordial',
    'crystal-ball': 'Bola de Cristal Profética',
    'guardian-barrier': 'Barreira Guardiã',
    'mutation-gun': 'Pistola de Mutação',
    'mystery-seed': 'Semente Misteriosa',
    'moon-dew': 'Orvalho Lunar',
    'drift-bottle': 'Garrafa Interestelar',
    'gene-modifier': 'Modificador Genético',
    'supernova-bottle': 'Garrafa Supernova',
    'star-tracker': 'Rastreador Estelar',
    'premium-seed': 'Semente Misteriosa Premium',
  ...
  marketTitle: '🏪 Loja',
  marketBalance: 'Moedas Melão',
  marketTabBuy: '🛒 Comprar',
  marketTabSell: '💰 Vender',
  marketBuyComingSoon: 'Em breve',
  marketBuyConfirmTitle: 'Confirmar compra',
  marketBuyConfirmMessage: (name, price, balance) => `Comprar ${name}? Custo ${price} 💰, saldo atual ${balance} 💰`,
  marketBuyConfirmButton: 'Comprar',
  marketBuyCancelButton: 'Cancelar',
  marketBuySuccess: 'Compra realizada',
  marketPlotSection: '🏗️ Expansão de lotes',
  marketPlotName: (index) => `Lote ${index + 1}`,
  marketPlotUnlocked: '✅ Desbloqueado',
  marketPlotConfirmTitle: 'Confirmar expansão',
  marketPlotConfirmMessage: (name, price, balance) => `Comprar ${name}? Custo ${price} 💰, saldo atual ${balance} 💰`,
  marketSellEmpty: 'Nenhuma melancia para vender',
  marketSellOwned: (count) => `Possui ×${count}`,
  marketSellConfirmTitle: 'Confirmar venda',
  marketSellConfirmMessage: (name, price) => `Vender ${name}? Você receberá ${price} 💰`,
  ...
  farmHarvest: 'Colher',
  farmWithered: 'Murcha',
  mutationRevealed: 'Ocorreu uma mutação!',
  mutationPositive: 'Mutante',
  mutationNegative: 'Doente',
  mutationWithered: 'A melancia murchou por causa da mutação...',
  mutationDowngraded: 'A mutação reduziu a qualidade...',
  mutationGunUse: 'Usar pistola',
  mutationChanceLabel: 'Chance de mutação',
  farmClear: 'Limpar',
  ...
  thiefAppeared: '⚠️ Um ladrão interestelar apareceu! Está se aproximando sorrateiramente...',
  thiefStealing: (m) => `⚠️ O ladrão está roubando melancias! Faltam ${m} min`,
  thiefStolen: '😱 Sua melancia foi roubada! O ladrão deixou um recibo de dívida...',
  thiefCaught: '🎉 Você pegou o ladrão! A melancia foi recuperada com recompensa extra',
  thiefNote: '📜 Recibo de dívida: Vou levar esta melancia por enquanto. Foque para recuperá-la!',
  thiefRecoveryActive: '📡 Rastreador Estelar ativo! O ladrão fugiu e a melancia foi recuperada',
  thiefRecoveryTask: '🏃 Recuperação por foco: Foque por 25 min em 24 h para recuperar 50% da colheita',
  thiefRecovered: '✨ Recuperação concluída! Você recuperou 50% da colheita',
  itemGuardianBarrierActive: '🎪 Barreira Guardiã ativa: toda a fazenda está imune a ladrões hoje',
  itemStarTrackerActive: '📡 Rastreador Estelar instalado: recuperação automática após roubo',
  itemNectarSuccess: '💧 Néctar Celestial ativado! A melancia reviveu',
  itemMoonDewSuccess: '🌙 Orvalho Lunar ativado! A raridade aumentou',
  itemMoonDewFail: '🌙 Já está na raridade máxima. O Orvalho Lunar não foi consumido',
  itemTrapNetSuccess: '🪤 Rede Armadilha Alienígena ativada! Ladrão interestelar capturado',
