...
- **惊喜感** - 隐藏成就让用户有探索欲和分享欲
- **有价值** — 徽章本身就是奖励，后续可按需绑定实际奖励（主题/音效等），但 v2 先留白
...
| S4 | 钢铁意志 | Iron Will | 连续打卡 30 天 | 三十天，你证明了什么叫坚持 |
| S5 | 百日传说 | Century Legend | 连续打卡 100 天 | 一百天不间断，你就是传说本身 |
...
| S10 | 西瓜元年 | Year One | 注册/首次使用满 365 天 | 一整年，你和西瓜时钟一起走过了四季 🎂 |
...
| F4 | 专注大师 | Focus Master | 累计专注 50 小时 | 五十小时的浇灌，荒漠变绿洲 |
| F5 | 专注传奇 | Focus Legend | 累计专注 100 小时 | 一百小时，你已经是时间的朋友 |
| F6 | 时间领主 | Time Lord | 累计专注 500 小时 | 时间在你手中不再流逝，而是绽放 |
...
| H3 | 金瓜降临 | Golden Arrival | 获得第 1 个金西瓜 | 传说中的金西瓜！你是被选中的人 ✨ |
...
| G5 | 图鉴大师 | Codex Master | 集齐全部 28 个品种 | 整个西瓜宇宙的品种，你一个不落 |
...
### 核心理念
集齐一个系列的全部徽章 → 寄一枚实体金属徽章给用户。这是最强的口碑传播素材，也是虚拟成就到现实世界的连接。

### 触发条件
- 集齐某个系列的全部徽章（如专注系列 10/10）→ 解锁该系列的实体徽章领取资格
- 总共 5 枚实体徽章（坚持/专注/瓜棚/农场/隐藏各一枚）
- 隐藏系列因为持续补充，以"当前版本全部集齐"为准

### 实体徽章规格
- 工艺：珐琅金属徽章，3-4cm
- 每枚背面刻唯一编号（如 #007/500）
- 每个系列对应不同颜色和图案，与 app 内一致
- 附带收藏卡片（品种/系列信息 + 用户昵称）

### 成本估算
| 项目 | 批量 500+ | 小批量 50 |
|------|----------|----------|
| 金属徽章（珐琅） | 3-5 元 | 8-12 元 |
| 包装（卡纸+小袋） | 1-2 元 | 1-2 元 |
| 国内快递 | 3-4 元 | 3-4 元 |
| 单个总成本 | ~8-10 元 | ~15-18 元 |

### 分阶段策略

**Phase 1：早期口碑炸弹（用户量 < 1000）**
- 前 500 名集齐的用户免费寄（含运费）
- 限量编号版，制造稀缺感
- 本质是获客成本，比投广告划算

**Phase 2：用户分担运费（用户量 1000-10000）**
- 徽章免费，用户自付运费（约 5 元）
- 过滤薅羊毛，筛选真正在乎的用户

**Phase 3：付费周边（用户量 > 10000）**
- 集齐后解锁"购买实体徽章"的权利（非免费）
- 定价 19.9-29.9 元/枚
- 没集齐的人买不到 → 稀缺感拉满
- 从成本项变成收入项

### 用户领取流程
1. 集齐系列 → app 内弹窗"🎉 恭喜集齐！解锁实体徽章"
2. 填写收货地址（需登录）
3. 后台生成发货单 → 人工/自动发货
4. 用户收到后 → app 内确认收货 → 解锁"实体收藏家"隐藏成就
