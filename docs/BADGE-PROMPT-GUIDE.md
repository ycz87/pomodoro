...
| 系列 | 徽章形状 | 底色 |
|------|----------|------|
| ⭐️ 坚持 | 圆形 Circular | 暖橙金 warm orange-gold |
| ⏱️ 专注 | 六边形 Hexagonal | 西瓜红 watermelon-red |
| 🏠 瓜棚 | 盾牌形 Shield | 翠绿 fresh green |
| 🌱 农场 | 方形圆角 Rounded square | 大地棕 earthy brown |
| 🌟 隐藏 | 星形 Star | 紫金 purple-gold |
